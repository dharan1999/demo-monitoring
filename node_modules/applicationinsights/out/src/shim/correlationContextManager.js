    ...
    static startOperation(input, request) {
        ...
        if (traceContext || headers) {
            ...
            if (traceContext) {
                ...
                if ((azureFnRequest === null || azureFnRequest === void 0 ? void 0 : azureFnRequest.headers) && !(azureFnRequest.headers instanceof undici_1.Headers)) {
                ...
                else if ((azureFnRequest === null || azureFnRequest === void 0 ? void 0 : azureFnRequest.headers) && (azureFnRequest === null || azureFnRequest === void 0 ? void 0 : azureFnRequest.headers) instanceof undici_1.Headers) {
            ...
            else if (headers && headers instanceof undici_1.Headers) {
